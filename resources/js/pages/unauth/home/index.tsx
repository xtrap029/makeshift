        ...
        <AppLayoutHeaderCustomer page="Welcome" fullWidth={true}>
            ...
            <div className="-mx-4 flex flex-col items-center">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 w-full max-w-7xl m-auto">
                    ...
                    <div className="bg-makeshift-black px-4 pt-6 pb-4 text-white md:col-span-1 md:bg-transparent md:text-black">
                ...
                <div className="w-full md:bg-makeshift-black md:py-3">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 max-w-7xl m-auto">
                        <div className="px-4 py-6 md:col-span-1 md:bg-makeshift-black md:text-white">
                            <h2 className="text-makeshift-header text-2xl">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 w-full max-w-7xl m-auto">
                    <div className="px-4 py-6 col-span-1">
                        <h2 className="text-makeshift-header text-2xl">
